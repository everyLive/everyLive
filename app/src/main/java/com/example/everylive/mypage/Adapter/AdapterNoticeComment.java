...
public class AdapterNoticeComment extends RecyclerView.Adapter<AdapterNoticeComment.MyViewHolder>{
    ...
    public AdapterNoticeComment(Context context, ArrayList<Item_notice_Comment> commentArrayList){
    ...
    private void requestRemoveComment(String idx_comment, int position){
        ...
        smpr.addStringParam("type", "notice"); // 댓글 작성자 idx : writer
